...
Pool.prototype.write = function(commands, options, cb) {
  ...
  // Always have options
  options = options || {};
  console.log("calling Pool.write", commands, options);
  ...
  if(options.monitoring) {
    ...
    console.log("added monitoring, length now", this.queue.length);
  } else {
    this.queue.push(operation);
    console.log("added non-monitoring, length now", this.queue.length);
  }
    ...
    waitForAuth(function() {
      ...
      while(true) {
        ...
        if(connection.isConnected()) {
          ...
          var workItem = self.queue.shift();
          console.log("got work item", workItem);
          console.log("queue now", self.queue.length);
