...
var ReplSetState = function(options) {
  ...
  // Server side
  console.log("RSS", this.id, "initializing");
  this.primary = null;
  this.secondaries = [];
  this.arbiters = [];
  this.passives = [];
...
ReplSetState.prototype.destroy = function(options) {
  ...
  this.unknownServers = [];
  this.set = {};
  console.log("RSS", this.id, "destroying");
  this.primary = null;
...
ReplSetState.prototype.remove = function(server, options) {
  ...
  if(this.primary && this.primary.equals(server)) {
    console.log("RSS", this.id, "removing server");
    console.trace();
    this.primary = null;
    this.topologyType = TopologyType.ReplicaSetNoPrimary;
    removeType = 'primary';
...
ReplSetState.prototype.update = function(server) {
  ...
  if(!this.primary && ismaster.ismaster && ismaster.setName) {
    ...
    if(locationIndex != -1) {
      console.log("RSS", self.id, "setting primary from update");
      self.primary = server;
      self.set[serverName] = {
    ...
    console.log("RSS", self.id, "setting primary from update 2");
    self.primary = server;
  ...
  if(ismaster.secondary && ismaster.setName
    ...
    if(this.primary
      && this.primary.name.toLowerCase() == serverName) {
        server.destroy();
      console.log("RSS", self.id, "removing primary from update 1");
      console.trace();
        this.primary = null;
  ...
  if(ismaster.passive && ismaster.setName
    ...
    if(this.primary
      && this.primary.name.toLowerCase() == serverName) {
        server.destroy();
      console.log("RSS", self.id, "removing primary from update 2");
      console.trace();
        this.primary = null;
        self.emit('left', 'primary', server);
    }
  ...
  if(this.set[serverName] && this.set[serverName].type == ServerType.RSPrimary) {
    ...
    this.primary.destroy();
      console.log("RSS", self.id, "removing primary from update 3");
      console.trace();
    this.primary = null;
    this.topologyType = TopologyType.ReplicaSetNoPrimary;
    return false;
