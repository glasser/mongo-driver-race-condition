...
function topologyMonitor(self, options) {
  ...
  if(_process === Timeout) {
    if (self.s.replicaSetState.unknownServers.length !== 0) {
      console.log("REPLSET: CNS on timeout", self.s.replicaSetState.unknownServers);
    }
  ...
  function executeReconnect(self) {
    return function() {
      ...
      if (self.s.replicaSetState.unknownServers.length !== 0) {
        console.log("REPLSET: CNS on interval", self.s.replicaSetState.unknownServers);
      }
...
function handleEvent(self, event) {
  return function() {
    ...
    console.log("REPLSET handle event", event);
...
ReplSet.prototype.connect = function(options) {
  ...
  console.log("REPLSET: calling connectServers");
...
ReplSet.prototype.isConnected = function(options) {
  ...
  if(this.authenticating) {
    console.log("RSISCONN: authenticating");
    return false;
  }
